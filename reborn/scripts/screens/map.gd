...
func _build()->void:
	...
	var positions:Array[Vector2]=[Vector2(155,845),Vector2(510,730),Vector2(210,540),Vector2(525,380),Vector2(355,190)]
	for i in range(state.LOCATIONS.size()):
		var loc:Dictionary=state.LOCATIONS[i]
		var pos:Vector2=positions[i]
		var b:=Button.new(); b.position=pos-Vector2(108,42); b.size=Vector2(216,84)
...
func _notification(what:int)->void:
	...
	for i in range(5):
		...
		if i<4:
			var next_p:Vector2=positions[i+1]
			draw_line(p,next_p,Color("#d6c27c",0.23),3)
